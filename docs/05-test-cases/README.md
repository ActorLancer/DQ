...
- `audit-consistency-cases.md`：已落地 `AUD-003~AUD-010` 的审计联查、证据包导出、replay dry-run、legal hold、anchor batch、canonical outbox / dead letter 查询、outbox publisher 与 SEARCHREC dead letter dry-run 重处理验收矩阵；后续 `Fabric / reconcile` 继续在同文件追加。
