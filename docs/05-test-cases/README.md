...
- `audit-consistency-cases.md`：已落地 `AUD-003~AUD-007` 的审计联查、证据包导出、replay dry-run、legal hold 与 anchor batch 首版验收矩阵；后续 `Fabric / reconcile / dead letter reprocess` 继续在同文件追加。
