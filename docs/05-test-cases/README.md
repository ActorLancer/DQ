...
- `audit-consistency-cases.md`：已落地 `AUD-003~AUD-008` 的审计联查、证据包导出、replay dry-run、legal hold、anchor batch、canonical outbox / dead letter 查询首版验收矩阵；后续 `Fabric / reconcile / dead letter reprocess` 继续在同文件追加。
