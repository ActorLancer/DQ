...
- `audit-consistency-cases.md`：已落地 `AUD-003~AUD-011` 的审计联查、证据包导出、replay dry-run、legal hold、anchor batch、canonical outbox / dead letter 查询、outbox publisher、SEARCHREC dead letter dry-run 重处理与一致性联查验收矩阵；后续 `Fabric / reconcile` 继续在同文件追加。
