...
- `prometheus`：采集宿主机运行的 `platform-core:8094`、`notification-worker:8097`、`outbox-publisher:8098`，以及 `mock-payment-provider`、`kafka-exporter`、`postgres-exporter`、`redis-exporter`、`minio-exporter`、`opensearch-exporter`
