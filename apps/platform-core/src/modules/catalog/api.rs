...
async fn create_preview_artifact(
    headers: HeaderMap,
...
fn validate_create_extraction_job_payload(
    raw_object_manifest_id_from_path: &str,
...
fn validate_create_preview_artifact_payload(
...
fn validate_create_asset_field_definition_payload(
    asset_version_id_from_path: &str,
