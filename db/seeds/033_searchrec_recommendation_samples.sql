...
INSERT INTO catalog.product_sku (
  ...
  ('20000000-0000-0000-0000-000000000409'::uuid, '20000000-0000-0000-0000-000000000309'::uuid, 'API_SUB', 'API_SUB', 'request', 'subscription', 'auto', 'partial', 'active', 'api_subscription', 'api', 'monthly', 'https', 'api', '{"seed":"searchrec014","standard_scenario_code":"S1","role":"primary"}'::jsonb),
  ('20000000-0000-0000-0000-000000000410'::uuid, '20000000-0000-0000-0000-000000000309'::uuid, 'API_PPU', 'API_PPU', 'request', 'metered', 'auto', 'partial', 'active', 'api_pay_per_use', 'api', NULL, 'https', 'api', '{"seed":"searchrec014","standard_scenario_code":"S1","role":"supplementary"}'::jsonb),
  ('20000000-0000-0000-0000-000000000411'::uuid, '20000000-0000-0000-0000-000000000310'::uuid, 'FILE_STD', 'FILE_STD', 'dataset', 'one_time', 'manual', 'full', 'active', 'snapshot_sale', 'file', NULL, NULL, 'file', '{"seed":"searchrec014","standard_scenario_code":"S2","role":"primary"}'::jsonb),
  ('20000000-0000-0000-0000-000000000412'::uuid, '20000000-0000-0000-0000-000000000310'::uuid, 'FILE_SUB', 'FILE_SUB', 'dataset', 'subscription', 'manual', 'partial', 'active', 'revision_subscription', 'file', 'monthly', NULL, 'file', '{"seed":"searchrec014","standard_scenario_code":"S2","role":"supplementary"}'::jsonb),
  ('20000000-0000-0000-0000-000000000413'::uuid, '20000000-0000-0000-0000-000000000311'::uuid, 'SBX_STD', 'SBX_STD', 'workspace', 'one_time', 'manual', 'none', 'active', 'sandbox_workspace', 'sandbox', NULL, NULL, 'sandbox_output', '{"seed":"searchrec014","standard_scenario_code":"S3","role":"primary"}'::jsonb),
  ('20000000-0000-0000-0000-000000000414'::uuid, '20000000-0000-0000-0000-000000000311'::uuid, 'SHARE_RO', 'SHARE_RO', 'dataset', 'one_time', 'auto', 'none', 'active', 'share_grant', 'table', NULL, 'db_link', 'share', '{"seed":"searchrec014","standard_scenario_code":"S3","role":"supplementary"}'::jsonb),
  ('20000000-0000-0000-0000-000000000415'::uuid, '20000000-0000-0000-0000-000000000312'::uuid, 'API_SUB', 'API_SUB', 'request', 'subscription', 'auto', 'partial', 'active', 'api_subscription', 'api', 'monthly', 'https', 'api', '{"seed":"searchrec014","standard_scenario_code":"S4","role":"primary"}'::jsonb),
  ('20000000-0000-0000-0000-000000000416'::uuid, '20000000-0000-0000-0000-000000000312'::uuid, 'RPT_STD', 'RPT_STD', 'report', 'one_time', 'manual', 'full', 'active', 'report_delivery', 'report', NULL, NULL, 'report', '{"seed":"searchrec014","standard_scenario_code":"S4","role":"supplementary"}'::jsonb),
  ('20000000-0000-0000-0000-000000000417'::uuid, '20000000-0000-0000-0000-000000000313'::uuid, 'QRY_LITE', 'QRY_LITE', 'query_run', 'one_time', 'manual', 'none', 'active', 'template_query', 'query_template', NULL, NULL, 'query_result', '{"seed":"searchrec014","standard_scenario_code":"S5","role":"primary"}'::jsonb),
  ('20000000-0000-0000-0000-000000000418'::uuid, '20000000-0000-0000-0000-000000000313'::uuid, 'RPT_STD', 'RPT_STD', 'report', 'one_time', 'manual', 'full', 'active', 'report_delivery', 'report', NULL, NULL, 'report', '{"seed":"searchrec014","standard_scenario_code":"S5","role":"supplementary"}'::jsonb)
